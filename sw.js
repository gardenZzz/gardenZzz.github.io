...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-253a83","is-html-253a83","is-jsdelivr-253a83","is-gtm-253a83","is-gravatar-253a83","is-theme-253a83","is-cdn-253a83","is-json-253a83"];
      return Promise.all(
        names
