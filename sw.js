...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-128f60","is-html-128f60","is-jsdelivr-128f60","is-gtm-128f60","is-gravatar-128f60","is-theme-128f60","is-cdn-128f60","is-json-128f60"];
      return Promise.all(
        names
