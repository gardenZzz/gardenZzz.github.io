...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-acbe2d","is-html-acbe2d","is-jsdelivr-acbe2d","is-gtm-acbe2d","is-gravatar-acbe2d","is-theme-acbe2d","is-cdn-acbe2d","is-json-acbe2d"];
      return Promise.all(
        names
