...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-ee4ac5","is-html-ee4ac5","is-jsdelivr-ee4ac5","is-gtm-ee4ac5","is-gravatar-ee4ac5","is-theme-ee4ac5","is-cdn-ee4ac5","is-json-ee4ac5"];
      return Promise.all(
        names
