...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-60565c","is-html-60565c","is-jsdelivr-60565c","is-gtm-60565c","is-gravatar-60565c","is-theme-60565c","is-cdn-60565c","is-json-60565c"];
      return Promise.all(
        names
