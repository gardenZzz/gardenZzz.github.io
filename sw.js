...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-9254e0","is-html-9254e0","is-jsdelivr-9254e0","is-gtm-9254e0","is-gravatar-9254e0","is-theme-9254e0","is-cdn-9254e0","is-json-9254e0"];
      return Promise.all(
        names
