...
self.addEventListener('install', function (event) {
  event.waitUntil(
    caches.keys().then(function (names) {
      var validSets = ["is-sw-d131ec","is-html-d131ec","is-jsdelivr-d131ec","is-gtm-d131ec","is-gravatar-d131ec","is-theme-d131ec","is-cdn-d131ec","is-json-d131ec"];
      return Promise.all(
        names
